...
// changes by nwack:
// - commented out the info function (we don't want libsvm output in gaia)
// - increased the line size when loading models to 4096 (just in case, you know...)
// - to compile on jaunty, we need to use the return value of fscanf
